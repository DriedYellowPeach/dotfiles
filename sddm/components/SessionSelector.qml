...
ColumnLayout {
    id: selector
    width: Config.sessionPopupWidth === -1 ? buttonWidth - Config.menuAreaPopupsPadding * 2 : (Config.sessionPopupWidth - Config.menuAreaPopupsPadding * 2) * Config.generalScale
