...
QtObject {
    ...
    property real passwordInputLetterSpacing: config.realValue("LoginScreen.LoginArea.PasswordInput/letter-spacing") // @desc:Spacing between password characters/dots.
